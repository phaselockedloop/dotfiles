;;; doom-megadark+-theme.el --- inspired by dark+ Theme by equinusocio -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup doom-megadark+-theme nil
  "Options for the `doom-dark' theme."
  :group 'doom-themes)

(defcustom doom-megadark+-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line.
Can be an integer to determine the exact padding."
  :group 'doom-megadark+-theme
  :type '(choice integer boolean))

(defcustom doom-megadark+-blue-modeline nil
  "If non-nil, mode-line's color will be blue instead of the default purple."
  :group 'doom-megadark+-theme
  :type '(choice integer boolean))

;;
(def-doom-theme doom-megadark+
  "A dark theme inspired by megadark+ Theme by equinusocio"

  ;; name        default   256       16
  ((bg         '("#000000" "#000000" nil))
   (bg-alt     '("#111111" "#111111"  nil))
   (base0      '("#171F24" "#111122" "black"))
   (base1      '("#1C1C1C" "#1C1C1C" "black"))
   (base2      '("#121212" "#626262" "black"))
   (base3      '("#313131" "#3a3a3a" "black"))
   (base4      '("#4b474c" "#444444" "black"))
   ...
   (-modeline-pad
    (when doom-megadark+-padded-modeline
      (if (integerp doom-megadark+-padded-modeline) doom-megadark+-padded-modeline 4))))
  ...
  ((lazy-highlight :background base4 :foreground fg :distant-foreground fg :weight 'bold)
   ...
   ;;;; tooltip
   (tooltip :background base6 :foreground fg)
   ;;;; treemacs
...
;;; doom-megadark+-theme.el ends here
