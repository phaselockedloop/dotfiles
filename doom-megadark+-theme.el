;;; doom-megadark+-theme.el --- inspired by dark+ Theme by equinusocio -*- no-byte-compile: t; -*-
(require 'doom-themes)
...
(def-doom-theme doom-megadark+
  "A megadark theme inspired by dark+ Theme by equinusocio"
